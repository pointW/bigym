...
class FlipCup(_ManipulationEnv):
    ...
    # Perturb mode reuses the nominal position distribution and only widens
    # the cup yaw range.
    _CUP_ROT_BOUNDS_ENHANCED = np.deg2rad(90)
    ...
    def _default_robot_init_overrides(self, robot_cls):
        ...
        return {
            "base_perturb_x_range": (0.0, 0.0),
            "base_perturb_y_range": (0.0, 0.0),
            "base_perturb_yaw_range": (0.0, 0.0),
            "ee_perturb_pos_range": (0.0, 0.0),
            "ee_perturb_rot_range": (0.0, 0.0),
        }
    ...
    def _on_reset(self):
        ...
        # Keep the table fixed for both reset modes.
